...
public class N2 {
	...
	public static void main(String[] args) {
		...
		Escola escola[] = new Escola[E];
	     ...
	     escola[3]=new Escola();
	     escola[3].codigo=44444;
	     escola[3].nome="IFSC";
	     escola[3].data="03-03-1994";
	     
	     escola[4]=new Escola();
	     escola[4].codigo=55555;
	     escola[4].nome="UFSC";
	     escola[4].data="05-05-1995";
	     
	     escola[0].alunos = new Aluno [A];
	     escola[1].alunos = new Aluno [A];
	     escola[2].alunos = new Aluno [A];
	     escola[3].alunos = new Aluno [A];
	     escola[4].alunos = new Aluno [A];
	     ...
	     for (int i = 0; i < E; i++)  {
	    	 ...
	    	 escola[i].alunos[5]= new Aluno();
	    	 escola[i].alunos[5].nome="Leticia";
	    	 escola[i].alunos[5].idade=18;
	    	 escola[i].alunos[5].sexo='F';
	         
	    	 escola[i].alunos[6]= new Aluno();
	    	 escola[i].alunos[6].nome="Geovana";
	    	 escola[i].alunos[6].idade=19;
	    	 escola[i].alunos[6].sexo='F';
